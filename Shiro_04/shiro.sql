...
(1,'权限','','',NULL,0,'0/','0','1'),
(11,'学生管理','menu','/student/tolist.do','student:tolist',1,'0/1/','1.','1'),
...
(15,'学生查询','permission','/student/list.do','stuent:list',11,'0/1/15/',NULL,'1'),
(21,'用户管理','menu','/user/userlist.do','user:userlist',1,'0/1/','2.','1'),
...
(25,'到学生列表','permission','/student/tolist.do','student:tolist',11,'0/1/11',NULL,'1'),
...
(31,'aaa','permission','/user/userlist.do','user:userlist',27,'0/1/27',NULL,'1'),
